  ...
  <section id="hero" class="d-flex flex-column justify-content-center" style="background-image: url('https://nicodwin.website/assets/common/img/cover/default.png');">
    ...
    @endforeach
      <p>I'm a <span class="typed" data-typed-items="Junior Web Developer, Technology Enthusiast, IT Engineer, Digital Marketing"></span></p>
      <a href="{{url('https://drive.google.com/file/d/1vDR71Ja2rrjonVYm9L536fPwksxXCw1U/view?usp=sharing')}}" target="=&quot;_blank&quot;" class="btn btn-primary mt-3">Download CV</a>
